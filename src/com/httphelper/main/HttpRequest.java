...
public abstract class HttpRequest extends HttpMessage {
	...
	public HttpResponse send() throws HttpHelperException {
	...
	private String getQueryParametersString() {
		return String.join(PARAMS_DELIMETER, this.queryParameters.stream()
	...
	public String getContent() {
		return String.join(PARAMS_DELIMETER, this.formParameters.stream()
			.map(Parameter::toString)
			.collect(Collectors.toList()));
	}
