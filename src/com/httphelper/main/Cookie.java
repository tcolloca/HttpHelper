...
class Cookie {
	...
	private static final List<DateTimeFormatter> FORMATTERS = Arrays.asList(
			DateTimeFormatter.ofPattern("EEE, d-MMM-uuuu H:m:s z", Locale.ENGLISH));
	...
	public int hashCode() {
		...
		int result = 1;
		result = prime * result
				+ ((cookieKeyValue == null) ? 0 : cookieKeyValue.hashCode());
		return result;
	}
	...
	public String toString() {
		String expirationDateStr = expirationDate.isPresent() ? 
				EXPIRES_KEY + expirationDate.get().format(FORMATTERS.get(0)) : "";
