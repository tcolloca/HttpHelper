...
public class Test {
	...
	public static void main(String[] args) throws HttpHelperException {
		HttpHelper helper = new HttpHelper("guiamt.net")
				.setDefaultHost("guiamt.net");
		
		HttpHelper.storeCookies = true;
		HttpHelper.log = true;
		
		long ini = System.nanoTime();
		HttpRequest req = helper.post()
				.addHeader(Headers.contentType(HttpContentType.APP_X_WWW_FORM_ENCODED))
				.addQueryParameter("id", "tu_cuenta")
				.addFormParameter("logUser", "tomatereloco")
				.addFormParameter("logPassword", "tomas123")
				.addFormParameter("remember", "1")
